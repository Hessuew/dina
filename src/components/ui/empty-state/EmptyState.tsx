...
import type { EmptyStateVariant } from '@/components/ui/empty-state/empty-state.domain'
import { Button } from '@/components/ui/button'
import {
  buildEmptyStateTextRows,
  getEmptyStateChrome,
} from '@/components/ui/empty-state/empty-state.domain'
...
export function EmptyState({
  ...
  const { shouldShowAction, buttonTheme, wrapperClassName } =
    getEmptyStateChrome({
      showAction,
      actionLabel,
