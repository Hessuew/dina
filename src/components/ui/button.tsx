  ...
  "group/button cursor-pointer inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 active:opacity-80",
  {
    variants: {
      ...
      theme: {
        ...
        lightGhost:
          'rounded-none font-serif tracking-[0.12em] text-[#1C1815] shadow-[0_16px_28px_-24px_rgba(0,0,0,0.18)] hover:-translate-y-0.5 hover:bg-black/10 focus-visible:border-[#C5A059]/80 focus-visible:ring-[#C5A059]/20',
      },
      size: {
        default:
