...
| Course content              | `courses`, `course_teachers`, `lessons`, `assignments`, `media_library`                              | Published student reads; assigned-teacher/Admin authoring                                                  | Outsider-teacher draft denial, student publication filtering, and DTO tests for private paths/content |
