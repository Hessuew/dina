...
| ✅ done | 246 | very-high | `ZoomLinkDialog`                | `src/components/dialog/zoom-link-dialog/ZoomLinkDialog.tsx:54`                          | `ZoomSectionField`, `ZoomTeacherField`, `ZoomMeetingFields`, `ZoomAccessFields`, `ZoomNoteFields` (per-section `withForm`), `ZoomLinkFields` (composer), `ZoomLinkHeader`, `ZoomLinkFooter` (JSX sub-components), `useZoomLinkDialog` hook (orchestration; reuses existing `zoom-link-dialog.domain` helpers)                                                                                                                                                                 | 2026-06-22 |
