...
moderate)** as of 2026-06-15, now **133 (16 critical / 46 high / 71 moderate)** open — the full
...
| ⬜ todo | 🟠 high | 56   | `requestPasswordResetService`   | A pure      | `src/utils/password-reset/service/password-reset.service.ts:22`              | —                                                          | —                               | —                    |
| ⬜ todo | 🟠 high | 56   | `resetPasswordService`          | A pure      | `src/utils/password-reset/service/password-reset.service.ts:111`             | —                                                          | —                               | —                    |
...
| ⬜ todo | 🟡 mod  | 42   | `goNext`                        | A hook      | `src/hooks/useEnrollmentReview.ts:156`                                       | —                                                          | —                               | —                    |
| ⬜ todo | 🟡 mod  | 42   | `goPrev`                        | A hook      | `src/hooks/useEnrollmentReview.ts:176`                                       | —                                                          | —                               | —                    |
...
| ⬜ todo | 🟡 mod  | 30   | `createCrudActions`             | A pure      | `src/components/table/functions/createCrudActions.ts:51`                     | —                                                          | —                               | —                    |
...
| ⬜ todo | 🟡 mod  | 30   | `deliver`                       | A pure      | `src/utils/notifications/delivery.ts:11`                                     | —                                                          | —                               | —                    |
