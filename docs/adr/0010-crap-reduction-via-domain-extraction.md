...
| 🔨 in progress | 🟡 mod  | 30   | `runInheritedCheck`             | A pure      | `scripts/quality-gate.mjs:62`                                                | —                                                               | —                               | hessuew / 2026-06-16 |
| 🔨 in progress | 🟡 mod  | 30   | `extractJson`                   | A pure      | `scripts/quality-gate.mjs:92`                                                | —                                                               | —                               | hessuew / 2026-06-16 |
| 🔨 in progress | 🟡 mod  | 30   | `reportFallowOutcome`           | A pure      | `scripts/quality-gate.mjs:239`                                               | —                                                               | —                               | hessuew / 2026-06-16 |
...
| ✅ done | 🟡 mod  | 30   | `<arrow>` (useCachedData refetch) | A hook    | `src/hooks/useCachedData/index.ts:37`                                       | `src/hooks/useCachedData/domain/cache-refetch.domain.ts`        | 1 CRAP finding (CRAP 30)        | hessuew / 2026-06-16 |
