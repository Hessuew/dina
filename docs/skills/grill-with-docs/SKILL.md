...
Ask the questions one at a time, waiting for feedback on each question before continuing. In `/plan` workflows, a batched AskUserQuestion prompt satisfies this interrogation step when related decisions should be chosen together.
